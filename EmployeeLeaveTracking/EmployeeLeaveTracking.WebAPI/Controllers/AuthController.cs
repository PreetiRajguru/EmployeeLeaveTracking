...
namespace EmployeeLeaveTracking.Controllers
{
    ...
    public class AuthController : BaseApiController
    {
        ...
        public async Task<IActionResult> RefreshToken(TokenModel tokenModel)
            ...
            System.Security.Claims.ClaimsPrincipal? principal = _repository.UserAuthentication.GetPrincipalFromExpiredToken(accessToken);
            if (principal == null)
            {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            JwtSecurityToken newAccessToken = _repository.UserAuthentication.CreateToken(principal.Claims.ToList());
            string newRefreshToken = _repository.UserAuthentication.GenerateRefreshToken();
        ...
        public async Task<IActionResult> ChangePassword(string userId, string currentPassword, string newPassword)
        {
            ...
            bool passwordValid = await _userManager.CheckPasswordAsync(user, currentPassword);
            if (!passwordValid)
            {
