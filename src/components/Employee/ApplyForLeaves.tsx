...
//     // Check if totalDays is NaN, 0, or greater than 5
//     if (
//       isNaN(newLeaveTypeDetails.totalDays) ||
//       newLeaveTypeDetails.totalDays === 0 ||
//       newLeaveTypeDetails.totalDays > 5
//     ) {
//       swal("Invalid total days. Please enter a valid number of days.");
//       return;
//     }
...
//         swal("Leaves for the same date are not accepted.");
//         return;
//       }
