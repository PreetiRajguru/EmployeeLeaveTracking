...
// const openModelPopup = async (rowId: any) => {
//   try {
//       console.log(data)
//       console.log("Row Id : ",rowId)
//   //   await axiosInstance.post(`/api/notifications/${rowId}/viewed`);
...
//               <TableCell align="right">Is Viewed</TableCell>
//             </TableRow>
//           </TableHead>
//           <TableBody>
//             {data.map((row: any) => (
...
//                 <TableCell align="right"><Button  onClick={() => openModelPopup(row.id)}>{row.leave.statusName}</Button></TableCell>
...
//                   {new Date(row.leave.endDate).toLocaleDateString()}
//                 </TableCell>
//                 <TableCell align="center">{row.leave.totalDays}</TableCell>
//                 <TableCell align="center">{row.leave.requestComments}</TableCell>
//                 {/* <TableCell align="right"><Button  onClick={() => openModelPopup(row.id)}>{row.leave.statusName}</Button></TableCell>
//                 */}
//                 <div>
//                 <TableCell align="right">{row.leave.statusId==1 ? <Button sx={{ml:2}} onClick={handleOpen}>{row.leave.statusName}</Button>: row.leave.statusName}</TableCell>
//                 <Modal
//                   open={open}
//                   onClose={handleClose}
